 ...
 * This file demonstrates how to integrate Duskzephyr with a web frontend
 */

// For React/Vue/Angular applications
export class DuskzephyrClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DuskzephyrClient(provider, contractAddress);
